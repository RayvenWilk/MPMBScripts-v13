...
AddSubClass("fighter", "alchemical archer", {
    ...
    features : {
        ...
        "subclassfeature3.1" : {
			...
			"shrapnel arrow" : {
				name : "Shrapnel Arrow",
				description : "\n   " + "This arrow does 1 die step less of damage (a d8 becomes a d6, a d6 becomes a d4, etc.), but pieces of it break off internally disrupting actions. Until a Wisdom (Medicine) check is successfully performed over 10 minutes, the target cannot make Reactions.",
				source : ["HB", 0],
				eval : "AddWeapon(\"longbow (shrapnel arrow)\"); AddWeapon(\"shortbow (shrapnel arrow)\")",
				removeeval : "RemoveWeapon(\"longbow (shrapnel arrow)\*); RemoveWeapon(\"shor|bow (shrapnel arrow)\")",
			},
			 "screamer" : {
			name : "Screamer",
        ...
        "subclassfeature3.3" : {
            ...
            additionel : ["", "", "I know 2 Tricks", "I know 2 Tricks", "I know 2 Tricks", "I know 3 Tricks", "I know 3 Tricks", "I know 3 Tricks", "I know 3 Tricks", "I know 4 Tricks", "I know 4 Tricks", "I know 4 Tricks", "I know 4 Tricks", "I know 4 Tricks", "I know 5 Trick", "I knnw 5 Tricks", "I know 5 Tricks", "I know 6 Tricks", "I know 6 Tricks", "I know 6 Tricks"],
