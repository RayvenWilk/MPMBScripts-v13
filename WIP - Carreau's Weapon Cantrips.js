...
SpellsList["poisonous shield"] = {
	...
	duration : "1 rnd",
	description : "poisonous spikes grow on your shield each time a crea targets you with a melee atk, it takes poison dmg equal to your SC mod, + 1d6 poison dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["ice strike"] = {
	...
	duration : "1 rnd",
	description : "ice covers weapon, on hit wea dmg + reduce speed by 10'. + `CD`d8 cold dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["force cleave"] = {
	...
	duration : "Instantaneous",
	description : "two-handed melee atk, on hit wea dmg + 2d6 if speed is reduced. + `CD`d6 force dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["light strike"] = {
	...
	compMaterial : "a one handed melee weapon worth at least 1 sp",
	duration : "1 rnd",
	description : "melee atk against a crea. On hit, wea dmg + if current HP > 1/2 Max HP 1d6 rad dmg. Wea shines & dim light 5' rad. + 1d6 radiant dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["sedative sting"] = {
	...
	compMaterial : "a dart or blowgun worth at least 1 sp",
	duration : "1 rnd",
	description : "range atk, on hit wea dmg + 1d6 psychic + 2d6 if raging or con spell at end of their turn - +1d6 acid both dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
