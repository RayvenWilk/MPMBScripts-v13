...
SpellsList["frosted arrow"] = {
	...
	duration : "1 rnd",
	firstCol : "atwill",
	description : "ranged atk, wea dmg + speed reduced 10'. + 1d8 cold dmg @ lvl 5th, 11th, & 17th",
	descriptionMetric : "ranged atk, wea dmg + speed reduced 3m. + 1d8 cold dmg @ lvl 5th, 11th, & 17th",
...
SpellsList["shining arrow"] = {
	...
	firstCol : "atwill",
	description : "ranged atk, wea dmg + can hit crea in line of target w/in 15ft for SC mod rad dmg. + 1d8 radiant dmg @ lvl 5th, 11th, & 17th ",
	descriptionMetric : "ranged atk, wea dmg + can hit crea in line of target w/in 5m for SC mod rad dmg. + 1d8 radiant dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["lightning throw"] = {
	...
	duration : "Instantaneous",
	firstCol : "atwill",
	description : "ranged atk, on hit - wea dmg, wea returns, sc mod lightning dmg to crea w/in 10ft of me - + 1d8 lightning dmg @ lvl 5th, 11th, & 17th",
	descriptionMetric : "ranged atk, on hit - wea dmg, wea returns, sc mod lightning dmg to crea w/in 3m of me - + 1d8 lightning dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([ 
...
SpellsList["ravenous throw"] = {
	...
	descriptionMetric : "ranged atk w/in 3m, wea dmg + next melee hit to same crea - 1d6 necrotic dmg. + 1d6 necrotic dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["acid pike"] = {
	...
	descriptionMetric : "melee atk, on hit, wea dmg + 5m dia of acid on ground, end turn in area 1d8 acid dmg. + 1d8 acid dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["tormeting pike"] = {
	...
	descriptionMetric : "melee atk, wea dmg + SC mod psychic dmg 1st time crea atk not you. 5th lvl add SC mod to dmg. + 1d8 psychic dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["poisonous shield"] = {
	...
	duration : "1 rnd",
	firstCol : "atwill",
	description : "poisonous spikes grow all over your shield every time a crea targets you with a melee atk, it takes poison dmg equal to your SC mod, + 1d6 poison dmg both @ lvl 5th, 11th, & 17th",
	descriptionMetric : "poisonous spikes grow all over your shield every time a crea targets you with a melee atk, it takes poison dmg equal to your SC mod, + 1d6 poison dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["resonant shield"] = {
	...
	duration : "1 rnd",
	firstCol : "atwill",
	description : "next crea to hit you w/ melee atk, must succeed on a str save, fail force dmg SC mod, pushed 5' knocked prone. + 1d8 force dmg @ lvl 5th, 11th, & 17th",
	descriptionMetric : "next crea to hit you w/ melee atk, must succeed on a str save, fail force dmg SC mod, pushed 1.5m knocked prone. + 1d8 force dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["ice strike"] = {
	...
	duration : "1 rnd",
	firstCol : "atwill",
	description : "ice covers weapon, on hit wea dmg + reduce speed by 10'. + 1d8 cold dmg @ lvl 5th, 11th, & 17th",
	descriptionMetric : "ice covers weapon, on hit wea dmg + reduce speed by 3m. + 1d8 cold dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["force cleave"] = {
	...
	descriptionMetric : "two-handed melee atk, on hit wea dmg + 2d6 if speed is reduced. + 1d6 force dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["light strike"] = {
	...
	descriptionMetric : "melee atk against a crea. On hit, wea dmg + if current HP > 1/2 Max HP 1d6 rad dmg. Wea shines & dim light 1.5m rad. + 1d6 radiant dmg both @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["corrosive cleave"] = {
	...
	nameShort : "Corrosive Cleave",
	nameAlt : "Corrosive Cleave",
	...
	descriptionMetric : "melee atk, on hit wea dmg + 1d6 acid if cur HP < 1/2 max HP - +1d6 acid both dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["venomous sting"] = {
	name : "Venomous Sting",
	nameShort : "Venomous Sting",
	nameAlt : "Venomous Sting",
	...
	descriptionMetric : "range atk, on hit wea dmg + 1d8 poison + 2d8 if target already poisoned - +1d8 acid both dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["sedative sting"] = {
	name : "Sedative Sting",
	nameShort : "Sedative Sting",
	nameAlt : "Sedative Sting",
	...
	descriptionMetric : "range atk, on hit wea dmg + 1d6 psychic + 2d6 if raging or con spell at end of their turn - +1d6 acid both dmg @ lvl 5th, 11th, & 17th",
	descriptionFull : desc([
...
SpellsList["electrified net"] = {
	...
	nameShort : "Electrified Net",
	nameAlt : "Electrified Net",
	classes : ["bard", "druid", "warlock", "wizard"],
	source : ["HB"],
	ritual : false,
	level : 0,
	...
	descriptionMetric : "on hit net dmg + target takes 2d8 lightning each time tries to get free - +1d8 lightning dmg @ 5th, 11th, & 17th lvl",
	descriptionFull : desc([
...
SpellsList["burning trap"] = {
	name : "Burning Trap",
	nameShort : "Burning Trap",
	nameAlt : "Burning Trap",
...
SpellsList["explosive trap"] = {
	name : "Explosive Trap",
	nameShort : "Explosive Trap",
	nameAlt : "Explosive Trap",
	classes : ["artificer", "druid", "wizard"],
	source : ["HB"],
	ritual : false,
	level : 0,
